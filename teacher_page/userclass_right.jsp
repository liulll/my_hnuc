...
<html>
	...
	<body>
		...
		<%
			...
			userclass=request.getParameter("name");
		%>
			...
			<div class="center">
					...
					<table align="center" border="1" width="800">
						...
						<%
							...
							String sql1="select * from stuInfo where userclass='"+userclass+"'";
	...
	<!-- 
	function openwin1() { window.open ("stuInfoadd.jsp", "newwindow", "height=200, width=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
	//写成一行 
	} 
	...
	function openwin3() { window.open ("stuInfoprint.jsp", "newwindow", "height=200, width=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
	//写成一行 
	} 
	//--> 
	</script> 
