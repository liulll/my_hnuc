...
<html>
	...
	<body>
		...
		<%
			...
			String acttype="waiting";	
			String stuyear=request.getParameter("syear");	
			...
			ResultSet rs=null;
			String sql2="insert into activityInfo values("+actno+",'"+actname+"','"+unit+"','"+stime+"','"+etime+"','"+duty+"','"+abstrac+"','"+content+"','"+stuyear+"','"+username+"','"+acttype+"')";
